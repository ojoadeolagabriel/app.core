...
namespace app.core.data.common.handler
{
    ...
    public class MsSqlHandler : IDatabaseSourceTypeHandler
    {
        ...
        {
            var query = string.Format(MsSqlHandlerSpTemplates.SelectById, entity, primaryKeyColumn, idValue);
            return query;
        }

        public string AutoGenerateSelectAllQuery(string entity)
        {
            var query = string.Format(MsSqlHandlerSpTemplates.SelectAll, entity);
            return query;
        }
        ...
        public string AutoGenerateUpdateQuery(string schema, IDictionary<string, object> data, string primaryKeyColumnName, string primaryKeyColumnValue)
        {
            ...
            var query = string.Format(MsSqlHandlerSpTemplates.Update, schema, setPart,
        ...
        {
            var query = string.Format(MsSqlHandlerSpTemplates.Delete, schema, primaryKeyColumnName, primaryKeyColumnValue);
            return query;
        }
        ...
        public string AutoGenerateCreateQuery(string schema, IDictionary<string, object> data)
        {
            ...
            var query = string.Format(MsSqlHandlerSpTemplates.Insert, schema, setPart, valuePart);
            return query;
        }
        ...
        private void ReadColumns(IDataRecord reader, IEntity entity)
        {
            ...
            object primaryKeyTypedColumnData = null;
            try
            {
                primaryKeyTypedColumnData = Convert.ChangeType(primaryKeyColumnData, entity.PrimaryKeyInfo.ColumnType);
            }
            catch
            {
